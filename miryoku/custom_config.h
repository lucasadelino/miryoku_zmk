...
&kp INS  K20  K21  K22  K23  K24  XXX       XXX  K25  K26  K27  K28  K29  &kp INS \
          &kp LEFT  &kp RIGHT  K32  K33  K34       K35  K36  K37  &kp UP  &kp DEL
...
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_NUM, RET),  U_LT(U_SYM, BSPC), U_LT(U_FUN, DOWN),  U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp INS,          &kp DEL,           U_NP,              U_NP
